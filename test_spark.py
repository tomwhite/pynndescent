...
class TestSpark(unittest.TestCase):
    ...
    def test_build_candidates(self):
        ...
        new_candidate_neighbors, old_candidate_neighbors = utils.build_candidates(current_graph.copy(), n_vertices, n_neighbors, max_candidates, spark.get_rng_state(42))
