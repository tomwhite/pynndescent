...
class TestSpark(unittest.TestCase):
    ...
    def test_build_candidates(self):
        ...
        candidate_neighbors_combined_rdd = \
            spark.build_candidates_rdd(current_graph_rdd, n_vertices, n_neighbors, max_candidates, chunk_size=4, rng_state=new_rng_state())
    ...
    def test_nn_descent(self):
        ...
        nn_spark = spark.nn_descent(self.sc, data, n_neighbors=n_neighbors, rng_state=new_rng_state(), chunk_size=4, max_candidates=max_candidates, n_iters=1, delta=0, rp_tree_init=False)
